...
from subsystemEngines.engines import Engine #Se tiene que hacer un llamado de la carpeta y del archivo
...
#Para hacer una encapsulacion de los atributos y ponerlos privados se hace con el __
